          ...
          <div className="grid grid-cols-2 gap-2 mb-4">
            <div className="bg-beach border text-center border-tertiary border-b-3 rounded-lg py-2.5 px-3">
              <div className="flex text-left items-center gap-1">
                <img
                  src={"/src/assets/images/icons/green-satar.png"}
            ...
            <div className="gap-2 bg-beach border text-center border-tertiary border-b-3 rounded-lg py-2.5 px-3">
              <div className="flex text-left items-center gap-1">
                <img
                  src={"/src/assets/images/icons/green-satar.png"}
                  className="bg-no-repeat bg-contain w-3 h-3 inline-block"
                />
                <p className="text-xs font-semibold text-primary-black">
                  Cashback on all UPI & card spends
                </p>
              </div>
            </div>
            <div className="bg-beach border text-center border-tertiary border-b-3 rounded-lg py-2.5 px-3">
            ...
            <div className="gap-2 bg-beach border text-center border-tertiary border-b-3 rounded-lg py-2.5 px-3">
              <div className="flex text-left items-center gap-1">
                ...
                />
                <p className="text-xs font-semibold text-primary-black">
                  Welcome voucher worth ₹250
                </p>
              </div>
            </div>
          </div>
          <div className="bg-accent-alt-primary rounded text-center mb-4">
            <button className="text-base font-bold leading-5 py-3.5 text-white">Resume application</button>
          </div>
        </div>
      </div>
    </>
